...
const i18n = {
  ar: {
    ...
    'about.p1': 'أنا <strong>مطوّر واجهة خلفية</strong> متخصص في بناء واجهات برمجية عالية الأداء، وأنظمة SaaS متعددة المستأجرين، وحلول الوقت الفعلي — أعمل عبر <strong>Php</strong> و<strong> Node.js</strong> — خريج تقنية المعلومات من الجامعة الإسلامية بغزة.',
    ...
    'skills.overText': 'أفضّل الأدوات التي تحسّن سرعة التسليم وسهولة الصيانة وموثوقية الإنتاج. الواجهة الخلفية هي تخصصي الأساسي — عبر منظومتي Laravel وNode.js — والواجهة الأمامية تدعم ذلك عند الحاجة.',
    'skills.m1': 'اللغات الأساسية',
    'skills.m2': 'الأطر الرئيسية',
  ...
  en: {
    ...
    'about.p1': 'I\'m a <strong>backend developer</strong> specialising in high-performance APIs, multi-tenant SaaS architectures, and real-time solutions — working across <strong>Php</strong> and <strong>Node.js</strong>. Graduate in Information Technology from the Islamic University of Gaza.',
    ...
    'skills.overText': 'I favour tools that improve delivery speed, maintainability, and production reliability. Backend is my core speciality — across the Laravel and Node.js ecosystems — with frontend supporting that when needed.',
    'skills.m1': 'Core languages',
    'skills.m2': 'Main frameworks',
    'skills.m3': 'Database',
